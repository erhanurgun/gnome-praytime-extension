...
assertEqual(APP_VERSION, '0.8.0', 'APP_VERSION doğru');
assertEqual(APP_VERSION_CODE, 20, 'APP_VERSION_CODE doğru');
assertEqual(APP_NAME, 'praytime@erho.dev', 'APP_NAME doğru');
assertEqual(APP_USER_AGENT, 'praytime@erho.dev/0.8.0', 'APP_USER_AGENT doğru format');
